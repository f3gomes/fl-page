                ...
                <form onSubmit={handleSubmit}>
                  <div className="flex flex-wrap gap-5">
                    ...
                    <button
                      ...
                      className="flex rounded-full bg-[#fe8d00] hover:bg-[#e67f00] px-7.5 py-2.5 text-white duration-300 ease-in-out dark:bg-btndark dark:hover:bg-blackho cursor-pointer"
                    >
                      Get Started
                    </button>
                  </div>
